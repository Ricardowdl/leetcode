<h2><a href="https://leetcode.cn/problems/count-special-triplets">Count Special Triplets</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code>.</p>
