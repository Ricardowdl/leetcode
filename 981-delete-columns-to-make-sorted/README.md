<h2><a href="https://leetcode.cn/problems/delete-columns-to-make-sorted">Delete Columns to Make Sorted</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given an array of <code>n</code> strings <code>strs</code>, all of the same length.</p>
