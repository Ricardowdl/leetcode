<h2><a href="https://leetcode.cn/problems/delete-columns-to-make-sorted-iii">Delete Columns to Make Sorted III</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an array of <code>n</code> strings <code>strs</code>, all of the same length.</p>
